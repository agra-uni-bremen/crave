...
struct Constraint : boost::proto::extends<Expr,
                    Constraint<Expr>, Constraint_Domain> {
  typedef boost::proto::extends<Expr, Constraint<Expr>,
          Constraint_Domain> base_type;
