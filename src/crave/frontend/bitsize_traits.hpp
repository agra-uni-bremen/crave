...
struct bitsize_traits<
    Integer, typename boost::enable_if<boost::is_integral<Integer> >::
                 type> : boost::mpl::times<boost::mpl::sizeof_<Integer>,
...
struct bitsize_traits<
    boost::mpl::integral_c<Integral, I> > : public bitsize_traits<Integral> {};

template <typename Enum>
struct bitsize_traits<Enum, typename boost::enable_if<boost::is_enum<
                                Enum> >::type> : bitsize_traits<int>::type {};
